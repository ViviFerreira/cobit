			...
			<div className='container'>
                ...
                <div className='contentCardTextModulo1_6'>
                    ...
                    <div className='textModulo1_6'>
                        <p className='primaryTextModule1_6'> Métricas e indicadores são utilizados para monitorar o progresso em direção aos objetivos estratégicos, <span>permitindo ajustes e melhorias contínuas.</span></p>
                    </div>
                </div>
				<div>
