		...
		<Layout>
			...
			<div className='container'>
				<div class='cardsModulo3_5'>
					...
					<div class='card-group'>
                        <div class='card1Modulo3_5 active'><p>Deliver, Service and Support</p></div>
                        <div className='line'></div>
						<div class='card1Modulo3_5 active'><p>Entregar, Servir e Apoiar</p></div>
						<div class='line-card line-active'></div>
					</div>
					<div class='card-group'>
						<Link to="/Modulo3_6">
